...
//				System.out.println(type);
		...
		String filename= origin.substring(origin.lastIndexOf("\\") + 1); //브라우저별로 경로가 포함되서 올라오는 경우가 있어서 간단한 처리
		//폴더생성
	...
	//비동기 업로드 - 넘어오는 데이터는 (jason 형식이 아니고) form형식이기 때문에 vo or requestParam으로 받으면됩니다.
